 ...
 * @returns {String}
 */
export function resolve(short: string): string;
/**
 * CDAV Library
 *
...
export namespace NS_MAP {
    export { DAV as d };
    export { IETF_CALDAV as cl };
    export { IETF_CARDDAV as cr };
    export { OWNCLOUD as oc };
    export { NEXTCLOUD as nc };
    export { APPLE as aapl };
    export { CALENDARSERVER as cs };
    export { SABREDAV as sd };
}
